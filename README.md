...
3. **Hands-on-Exercise #1**
   - [print out a some text with emojis](03.%20Hands-on-Exercise%20%23#1/1_text-with-emoji.go)
   - [print out a raw string literal](03.%20Hands-on-Exercise%20%23#1/2_raw-string-literal.go)
